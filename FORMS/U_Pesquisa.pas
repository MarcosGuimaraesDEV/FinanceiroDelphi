...
begin
  //Transferir o ID para a variável Codigo
...
begin
  ...
  case DBChave.ItemIndex of  //Pesquisa por código
    0: begin
  ...
  while not QPesquisa.Eof do
    begin
      ...
      if QPesquisaTIPO.AsString='SAÍDA' then
        begin
  ...
  LBSaida.Caption:= 'Saída: ' + formatfloat('R$ ##,##0.00',Saida);
  LBCaixa.Caption:= 'Caixa: ' + formatfloat('R$ ##,##0.00',Caixa);
  //Se não encontrar mostra a mensagem
...
begin
  ...
  case DBChave.ItemIndex of 0:
    begin
      ...
      LB_Descricao.Caption:='Digite o código:';
  ...
  1:
   ...
   3:
    begin
      ...
      LB_Descricao.Caption:='Digite o período:';
      MK_Inicio.Visible:=true;
      LB_Inicio.Visible:=true;
...
begin
  //Fazer a função do botão trasnferir com duplo clique
  BtTransferir.Click;
end;
